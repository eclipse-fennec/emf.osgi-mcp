...
The Maven group-id is defaulted to **org.eclipse.fennec.mcp** in *cnf/build.bnd* using the bnd **-groupid** instruction.

## Github - Create Project
- Create a empty [GitHub repository](https://github.com/organizations/eclipse-fennec/repositories/new)
  - Name: `org.eclipse.fennec.mcp`
...
## Sonarcloud
  ...
  - Analyze new project
  - check `org.eclipse.fennec.mcp` and `SetUp`
  ...
  - GitHub -> Project-Settings -> Secrets -> [New Repository Secrets](Link: https://github.com/eclipse-fennec/org.eclipse.fennec.mcp/settings/secrets/actions/new)
    - add `SONAR_TOKEN`
...
git branch -M main
git remote add origin git@github.com:eclipse-fennec/org.eclipse.fennec.mcp.git
...
- Project -> Settings  -> Branches [add rule](https://github.com/eclipse-fennec/org.eclipse.fennec.mcp/settings/branch_protection_rules/new)
...
- [Jenkins GitHub-Group](https://devel.data-in-motion.biz/jenkins/job/GH/) should show `org.eclipse.fennec.mcp`
- [Jenkins org.eclipse.fennec.mcp branches](https://devel.data-in-motion.biz/jenkins/job/GH/job/org.eclipse.fennec.mcp/)
