...
public class AddEOperationTool extends AbstractEMFTool {
		...
		this.inputSchema = """
				{
					...
					"properties": {
						...
						"name": { "type": "string" },
						"eType": { "type": "string", "description": "return type ref or dataset objectId; omit for void" },
	...
	public Mono<McpSchema.CallToolResult> execute(McpAsyncServerExchange exchange, Map<String, Object> arguments) {
		return run(() -> {
			...
			String eTypeRef = optionalString(arguments, "eType");
			if (eTypeRef != null) {
				operation.setEType(EcoreAuthoring.resolveClassifier(dataset, resolver, eTypeRef));
			}
