...
// (guides.mjs) — internal docs (design plans, issue reports) are deliberately
// NOT published. Cross-links inside the published docs that point at a
// NON-published file are rewritten to the GitHub blob URL so they keep working
// instead of 404-ing on the site; links between published docs become sibling
// routes.
//
...
const blobBase = `https://github.com/eclipse-fennec/emf.osgi-mcp/blob/${branch}/docs`;
